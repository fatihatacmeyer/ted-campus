...
// import { MOCK_ACTIVITIES } from './activities.mock';
...
//   constructor() {
//     this.activityForm.get('isPaid')!.valueChanges.subscribe(paid => {
...
//   getGroupSelectedCount(group: { label: string; items: { label: string; value: string }[] }): number {
//     const selected: string[] = this.activityForm.get('classroom')?.value || [];
...
//       requestStartDate: activity.requestStartDate ? new Date(activity.requestStartDate) : null,
//       requestEndDate: activity.requestEndDate ? new Date(activity.requestEndDate) : null,
//     });
//     this.isDialogVisible.set(true);
//   }
...
//     const formatDt = (date: Date | null | string) => {
//       if (!date) return '';
...
//       oKod4: '',
//       oKod5: '',
//       startDate: formatDt(formValues.startDate),
//       endDate: formatDt(formValues.endDate),
//       requestStartDate: formatDt(formValues.requestStartDate),
//       requestEndDate: formatDt(formValues.requestEndDate),
//     };
...
//         list.map((a) => (a.id === currentActivity.id ? { ...a, ...payload } : a)),
//       );
//     } else {
