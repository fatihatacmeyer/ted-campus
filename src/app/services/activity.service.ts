...
// //   apiUrl = `${this.config.apiUrl}/PersonList`;
...
// //     return this.http.get<ActivityInterface[]>(this.apiUrl);
// //   }

// //   getActivityById(id: number): Observable<ActivityInterface> {
// //     return this.http.get<ActivityInterface>(`${this.apiUrl}/${id}`);
// //   }

// //   addActivity(activity: Partial<ActivityInterface>): Observable<ActivityInterface> {
// //     return this.http.post<ActivityInterface>(this.apiUrl, activity);
// //   }

// //   updateActivity(id: number, activity: Partial<ActivityInterface>): Observable<ActivityInterface> {
// //     return this.http.put<ActivityInterface>(`${this.apiUrl}/${id}`, activity);
// //   }
